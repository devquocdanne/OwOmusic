...
module.exports = {
	data: new SlashCommandBuilder()
   		.setName("join")
   		.setDescription("Mời bot đến kênh thoại hiện tại mà bạn đang sử dụng")
	...
	run: async ({ client, interaction }) => {
		...
		try {
            ...
            return interaction.editReply({ 
                embeds: [embed.setDescription(`Đã tham gia thành công <#${interaction.member.voice.channelId}>`)], 
                ephemeral: true 
            });
