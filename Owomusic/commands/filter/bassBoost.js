    ...
    run: async ({ interaction, client }) => {
        ...
        try {
            ...
            if (enabled) {
                ...
                return interaction.reply({ embeds: [embed.setDescription(`\`✅\` | Hiệu ứng tăng âm trầm được kích hoạt với mức ${level !== null ? level : 1.0}.`)] });
            } else {
                player.filters.setBassBoost(false);
                return interaction.reply({ embeds: [embed.setDescription(`\`✅\` | Hiệu ứng tăng âm trầm bị vô hiệu hóa.`)] });
            }
