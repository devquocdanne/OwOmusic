...
module.exports = async (client) => {
    client.riffy.on('trackStart', async (player, track) => {
        ...
        const getEmbed = (loopMode = player.loop, volume = player.volume, iconURL = "https://s14.gifyu.com/images/bHCiW.gif") => 
            new EmbedBuilder()
        ...
        collector.on("collect", async (message) => {
            ...
            if (shouldUpdateMsg) {
                await msg.edit({ embeds: [getEmbed(player.loop, player.volume, trackThumbnail, "https://ibb.co/Q7TNh2kw")], components: newRows });
            }
        });
    });
};